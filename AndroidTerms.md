...
- **Application** means the software program provided by the Company and downloaded by You on a Device, named Waddle: Beginner Running Coach.
- **Application Store** means Google Play or another digital distribution service through which You downloaded the Application.
...
- **Device** means a device that can access or run the Service, such as a compatible Android phone.
...
Your use of the Service is also subject to Our [Privacy Policy](https://spammusubitech.github.io/waddle-to-run/android/privacy/), which explains how the Application handles location and route data, running plans and progress, Health Connect records, local storage and manual backups, notifications, route sharing, purchases and support requests.
...
Waddle: Beginner Running Coach is a beginner-friendly walking and running app. It may provide onboarding, adaptive training plans, scheduled runs, run-walk intervals, GPS route tracking, pace and distance estimates, automatic pause detection, planned routes, route cards, route postcards, reminders, audio and haptic cues, run reflections, progress summaries, streaks, badges, goose customization, manual backup export and restore, optional Health Connect exercise saving, and Subscription-based premium features.

Features may vary by Device, operating system, country, Application Store configuration, permission choices, Subscription state, storage availability, GPS conditions, and Application version.
...
Some features require location permission. If You deny or revoke permission, GPS tracking, route cards, distance estimates, or related features may not work, and the Application may use timer-based behavior.
...
If You enable Health Connect saving and grant permission, the Application may write completed walking or running sessions and distance records to Health Connect. The Application does not request health-data read permissions. Health Connect behavior is controlled by Android, Google, and Your settings.

You are responsible for reviewing saved records. Activity type, time, duration, and distance may be inaccurate because of GPS, user input, Device, or software behavior. Do not rely on a record created by the Service for medical, insurance, employment, legal, or safety-critical decisions.

Turning off saving or deleting the Application does not delete records already written to Health Connect. You can manage those records in Health Connect. Deleting a saved run in the Application attempts to remove its Health Connect copy and may require You to restore permission first.

## Local Storage, Backups, and Data Loss

Application data is stored locally on Your Device. Android automatic cloud backup and device transfer of Application data are disabled. You can export and restore a compatible backup using the Application’s controls. A full backup includes saved routes and personal reflections; postcard privacy settings do not redact it. Keep backups private.

Restoring replaces local data after confirmation. It does not grant Premium, Health Connect permission, or notification permission. There is no automatic synchronization between devices.

You are responsible for maintaining copies You need. Data may be lost, duplicated, corrupted, or unavailable because of Device failure, deletion, storage limits, operating system updates, or other events. Deleting local data does not delete copies previously exported, shared, or saved in Health Connect or purchase systems.

## Route Postcards and User Content

You may enter optional notes, name routes, draw routes, and create shareable route postcard images. You retain ownership of content You create, subject to the rights necessary for the Application and services You select to store, process, render, and share it at Your direction.
...
When You use the Android share sheet, Your content is sent to the destination You choose. Third-party services and recipients are responsible for their own handling of that content.
...
If You downloaded the Application from Google Play, Your use of Google Play and its payment services is subject to Google Play’s applicable terms. These Terms govern Your relationship with the Company for the Application. The Company provides Application support using the contact information below.

Manage or cancel Your Subscription through the Google Play account used for the purchase. Uninstalling the Application or deleting local data does not cancel a Subscription.
...
- Interfere with the Service, Application Store, Android services, RevenueCat, legal-page hosting, or other Service Providers.
...
We do not warrant that the Service will meet Your requirements, improve fitness, prevent injury, produce a particular running result, track every route accurately, work with every Device or third-party service, preserve every record, deliver every reminder, restore backups without error, or be free from defects.
...
If You have questions about these Terms, contact Us at [contact@spammusubitech.com](mailto:contact@spammusubitech.com).
